...
@Component({
    selector: 'page-parttracker',
    templateUrl: 'parttracker.html'
})
export class PartTracker {
    selectedItem: any;
    partTracker: Array<{ ID: string, labourType: string, startTime: string, srCurrencyCode: string }>;
    ...
    constructor(private _service: ServiceCompoment, public navCtrl: NavController, public navParams: NavParams) {
        ...
        this.partTracker = this.selectedItem;
    }
